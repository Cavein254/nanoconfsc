...
@pytest.mark.parametrize("set_envars", [("simple_overridden", "True")], indirect=True)
...
def test_nested():
    ...
    assert nconf.animals.lion.diet == "Carnivore"
